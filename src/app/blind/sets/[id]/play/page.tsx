  ...
  return (
    <div className="flex h-full flex-1 flex-col overflow-hidden">
      <div className="flex h-12 shrink-0 items-center justify-between border-b border-border bg-surface px-6">
        <Link href={`/blind/sets/${setId}`} className="text-sm text-text-2 hover:text-text-1">
          &larr; Back to set
        </Link>
        <ThemeToggle />
      </div>

      <div className="flex items-center justify-between border-b border-border bg-warning/10 px-6 py-2 text-xs text-warning">
